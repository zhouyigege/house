        ...
        <DIV class=infos>
          <TABLE class=field>
            ...
            <TR>
              ...
              <INPUT id=d class=text value="${h.id}" type=hidden name=id>
            ...
            <TR>
              ...
              <TD><INPUT id=add_action_floorage class=text value="${h.floorage}" type=text
                         name=floorage></TD></TR>
            <TR>
            ...
            <TR>
              <TD class=field>发布日期：
                <INPUT id=date class=text type=hidden name=delimage value="${h.path}">


              </TD><TD><INPUT class=text type=date value="<fmt:formatDate value="${h.pubdate}" pattern="yyyy-MM-dd"></fmt:formatDate>" name=pubdate></TD></TR>
            <TR>
