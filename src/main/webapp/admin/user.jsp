...
<body>
<!--显示所有区域-->
<table  style="width: 1000px; height: 500px " id="dg">
...
<div id="ToolBar">
    ...
    <div>名称:<input type="text" id="inputname" name="name">
        电话:<input type="text" id="inputtel" name="telephone">
        <a id="btn" href="javascript:userSearch()" class="easyui-linkbutton" data-options="iconCls:'icon-search'" plain="true">搜索</a>
    </div>
